...
async function startGame() {
  ...
  try {
    ...
    if (syncResult.staleList) {
      appendConsole('[Лаунчер] ⚠ Не удалось получить свежий список модов (нет доступа к GitHub и зеркалу). Моды сверены по сохранённому списку — сборка может быть устаревшей, и сервер может не пустить. Проверь интернет или включи VPN и запусти игру заново.\n', 'stderr');
    } else {
